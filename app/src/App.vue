...
2016年09月15日。小狗开始和姐姐一起睡觉(姐姐给小狗最好的奖励呢)。  
已有 \`${getDateDiff((new Date()).getFullYear()+'-'+((new Date()).getMonth()+1)+'-'+(new Date()).getDate(),'2025-01-09') + 1}\` 天
...
* 2025年1月17日姐姐不喜欢撸射，小狗就后面没有撸射过了(小狗听话但还是有点想要呢~~)

一起玩过的游戏
----

王者荣耀(姐姐什么时候带小狗上分呀小狗想躺呢)
